...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView previewing = (ImageView)dialog.findViewById(R.id.previewimg);
        ...
        img_left.setImageResource(array.images2[numLeft]); // достаем соответствующую картинку
        text_left.setText(array.text2[numLeft]); // достаем текст
        ...
        img_right.setImageResource(array.images2[numRight]); // достаем соответствующую картинку
        text_right.setText(array.text2[numRight]); // достаем текст
